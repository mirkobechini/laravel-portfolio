    ...
    @foreach ($projects as $project)
        <div class="card mb-3">
            <div class="card-body">
                ...
                <button type="button" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal-{{ $project->id }}" class="btn btn-danger">Elimina</button>
            </div>
        </div>

        <!-- Modal per progetto {{ $project->id }} -->
        <div class="modal fade" id="confirmDeleteModal-{{ $project->id }}" tabindex="-1" aria-labelledby="confirmDeleteModalLabel"
            aria-hidden="true">
